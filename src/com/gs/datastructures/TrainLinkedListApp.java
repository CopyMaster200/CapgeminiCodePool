...
public class TrainLinkedListApp {
	...
	private void buildInitialTrain() {
		...
		System.out.println("Train is built correctly. found and retrieved the paper car at position: " + paperCar
				+ " - " + position);
	...
	private void firstStop() {
		...
		// at this stop we need to pull off the first box car and insert a new BoxCar
	...
	private void secondStop() {
		...
		// at this stop we need to pull off all of the tanker cars. They should start at
		// position 5 and there's 3 of them
	...
	private void lastStop() {
		...
		// at this stop we simply pull the remaining cars off of the train until we have
		// no more train.
		...
		try {
			...
			// when we get an ise that means we don't have any more cars to remove and the
			// train is now empty
		}
