...
public class MotorcycleOilChangeApp {
	...
	private void drainAndReplaceOil() {
		...
		// this motorcycle's drain plug nut is 17mm. That's a strange size, check to see
		// if the toolset has it
		System.out.println(
				"Toolset has 17mm socket: " + toolset.hasValue("17mm Socket") + " - " + toolset.hasKey("17mm"));
